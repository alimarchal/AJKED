...
@section('content')
    ...
    <form method="post" action="{{route('product.stockOutSchemeStore')}}" onsubmit="return confirm('Do you really want to submit the form?');" enctype="multipart/form-data">
        @csrf
        <div class="form-row">


            <input type="hidden" name="chalan_type" value="SchemeStockOut">
