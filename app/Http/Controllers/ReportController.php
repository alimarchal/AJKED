    ...
    public function stockReturn(Request $request)
    {
        ...
        if ($request->has('month')) {
            ...
            $stock_in_out = DB::table('stock_in_outs')
                ...
                ->where('stock_in_outs.type', '=', 'Out')
                ->whereBetween('stock_in_outs.indent_date', [$date_from, $date_to])
            ...
            return view('report.stockReturn', compact('stock_in_out', 'date_from','received_material'));
        } else {
